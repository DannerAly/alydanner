  ...
  return (
    <nav className="w-full bg-[#042F40] text-white shadow-md fixed top-0 left-0 z-50">
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        <Link to="/" className="text-2xl flex flex-row items-center hover:text-cyan-400 transition" onClick={() => { setOpen(false); setSubMenuOpen(false); }} aria-label="Ir a Sobre Aly">
          <b>Aly</b> <p>Danner</p> <img src={Max} className="w-10" alt="Logo" />
        </Link>
        {/* Desktop menu */}
